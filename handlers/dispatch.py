...
from handlers.configurate_bot import handle_cb_lang_config_button, handle_cb_show_config, handle_cb_switch_lang
...
from handlers.edit_sayings import handle_cb_update_saying, handle_mss_update_saying
